...
`;
const FirstRoute = () => (
  <View style={{backgroundColor: '#ff4081', padding: 10}}>
    <HTML
...
export default function MyClassDetail(props) {
  ...
  const routes = [
    ...
    {key: '2', title: 'Class Progress'},
    {key: '3', title: 'Class Discussion'},
  ];
          ...
          <View style={styles.information}>
            ...
            <View>
              ...
              <View
                ...
                <Text style={styles.subInformationText}>Level : Beginner</Text>
                <Text style={styles.subInformationText}>
                  Category : Software
                </Text>
                <Text style={styles.subInformationText}>Price : Free</Text>
              </View>
            </View>
          </View>
        </ImageBackground>
